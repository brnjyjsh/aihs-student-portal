...
<div class="content py-2">
    <div class="col-12">
        <div class="card card-outline card-navy shadow rounded-0">
            ...
            <h2>My Grades - Grade 12 <?= $userData['section'] ?> </h2>
                <div class="accordion" id="outprint">
                    <?php
                    // Query to get the unique quarters and school years for the user
                    ...
                    WHERE a.student_id = '{$id}' AND sec.grade_level_id = 2");
                    ...
                    if ($quarterQuery->num_rows > 0) {
                        ...
                        <colgroup>
                            ...
                            <tbody>
                                ...
                                $subjectQuery = $conn->query("SELECT a.*, c.name AS subject, c.subject_code, e.name AS semester, f.name AS quarter, g.grade AS student_grade, st.name AS subject_type_name
                                FROM student_subject a
                        ...
                        // Display message when there are no quarters found
                        echo '<div class="text-center">No enrolled subjects found for Grade 12.</div>';
                    }
                    ?>
                </div>
            </div>
...
<noscript id="print-header">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <br>
            <h3 class="text-center"><b>My Grades - Grade 12 <?= $userData['section'] ?></b></h3>
            <br>
            <br>
        </div>
        <div class="col-2"></div>
...
$('#print').click(function(){
        ...
        var printedByText = $('<p style="position: absolute; bottom: 30px; right: 30px;">Printed by <b>ICT Coordinator</b></p>');
