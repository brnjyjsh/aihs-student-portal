...
<div class="card card-outline card-navy rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title" style="font-weight: bold;">List of Grade Level</h3>
		<div class="card-tools">
			<button class="btn btn-sm btn-info bg-info btn-flat" type="button" id="print"><i class="fa fa-print"></i> Print</button>
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-navy bg-navy"><span class="fas fa-plus"></span>  Add Grade level</a>
		</div>
	</div>
	<div class="card-body" >
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-hover table-striped" id="outprint">
				...
				<tbody>
					<?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `grade_level_list` where delete_flag = 0 order by `name` asc ");
...
<noscript id="print-header">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <br>
            <h3 class="text-center"><b>Grade Level Records</b></h3>
            <br>
            <br>
        </div>
        <div class="col-2"></div>
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Add New Grade Level","grade_level/manage_grade_level.php")
		})
		$('.view_data').click(function(){
			uni_modal("Grade Level Details","grade_level/view_grade_level.php?id="+$(this).attr('data-id'))
		})
        $('.edit_data').click(function(){
			uni_modal("Update Grade Level Details","grade_level/manage_grade_level.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Grade Level permanently?","delete_grade_level",[$(this).attr('data-id')])
		})
    ...
    _el.append(_h);
    _el.append(_ph);
    _el.find('title').text('Grade Level Records - Print View');
    _el.append(_p);
