...
<div class="card card-outline card-navy rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title" style="font-weight: bold;">List of School Year</h3>
		<div class="card-tools">
		<button class="btn btn-sm btn-info bg-info btn-flat" type="button" id="print"><i class="fa fa-print"></i> Print</button>
		<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-navy bg-navy"><span class="fas fa-plus"></span> Add School Year</a>
		</div>
	</div>
	<div class="card-body" >
...
<noscript id="print-header">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <br>
            <h3 class="text-center"><b>School Year Records</b></h3>
            <br>
            <br>
        </div>
        <div class="col-2"></div>
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Add New School Year","school_year/new_school_year.php")
		})
        $('.edit_data').click(function(){
			uni_modal("Update School Year Details","school_year/manage_school_year.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this School Year permanently?","delete_school_year",[$(this).attr('data-id')])
		})
	...
	function delete_school_year($id){
		start_loader();
		$.ajax({
			url:_base_url_+"classes/Master.php?f=delete_school_year",
			method:"POST",
			data:{id: $id},
			dataType:"json",
			error:err=>{
    ...
    _el.append(_h);
    _el.append(_ph);
    _el.find('title').text('School Year Records - Print View');
    _el.append(_p);
