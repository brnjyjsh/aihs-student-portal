...
<div class="card card-outline card-navy rounded-0 shadow ">
	<div class="card-header">
		<h3 class="card-title" style="font-weight: bold;">Select Strand/Track</h3>
					...
					?>
						...
						<td align="center">
							...
							if ($row['status'] == 1) {
								...
								echo '<a href="./?page=student_grades/section&id=' . $row['id'] . '" class="btn btn-flat btn-default btn-sm border">Select</a>';
							} else {
