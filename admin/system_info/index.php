...
<div class="col-lg-12">
	<div class="card card-outline card-navy rounded-0 shadow">
		<div class="card-header">
			<h5 class="card-title" style="font-weight: bold;">System Information</h5>
			<!-- <div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_strand" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New</a>
			</div> -->
		</div>
		<div class="card-body">
