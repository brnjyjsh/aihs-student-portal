...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    extract($_POST);
    $stmt = $conn->prepare("SELECT * FROM `teacher_list` where `username` = ?");
    ...
    if($result->num_rows > 0){
        ...
        $subject = "Amadeo Integrated High School Student Portal - Reset Password (TEACHER)";
        $message = "";
        ob_start();
        include("reset_mail-template-teacher.php");
...
<div class="d-flex align-items-center" id="login">
    <div class="col-sm-12 col-md-6 col-lg-3">
        <div class="rounded-0">
            <center><img src="uploads\logoflat-teacher.png" style="margin-top: 25px;" alt="" id="logo-img"></center>
        </div>
    </div>
</div>
                            ...
                            <div id="slogin" class="tabcontent"> <!--LOG IN TAB-->
                                ...
                                <?php if(isset($_SESSION['msg']['success']) && !empty($_SESSION['msg']['success'])): ?>
                                        ...
                                        <div class="col-lg-13">
                                            ...
                                            <br>
                                            <center><p style="font-weight: normal; color: white; font-family: sans-serif; font-size: 14px;" >Log in as <a href="login.php" style="color: #f4a410; text-decoration: none;">Student</a> or <a href="admin/login.php" style="color: #f4a410; text-decoration: none;">Admin</a>
                                        </center>
                                            </div>
                                        </div>
                                </form>
...
<script>
  $(document).ready(function(){
    ...
    $('#slogin-form').submit(function(e){
        ...
        start_loader();
        $.ajax({
            url:_base_url_+"classes/Login.php?f=teacher_login",
            method:'POST',
