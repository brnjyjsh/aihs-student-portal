...
<div class="col-lg-12">
    <div class="card card-outline card-navy shadow rounded-0">
        <div class="card-header rounded-0">
            <h5 class="card-title"><b>Update Details</b></h5>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact" id="contact" placeholder="Contact Number" class="form-control form-control-border" required value="<?= isset($contact) ?$contact : "" ?>">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group text-center">
                                ...
                                <a href="./?page=teacher_profile" class="btn btn-light border btn-flat"> Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
